...
var weather_node
const RAIN_HEAVY = preload("res://Maps/Weather/rain_heavy.tscn")
const RAIN_LIGHT = preload("res://Maps/Weather/rain_light.tscn")
const RAIN_NORMAL = preload("res://Maps/Weather/rain_normal.tscn")
const SNOW = preload("res://Maps/Weather/snow.tscn")
